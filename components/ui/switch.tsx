    ...
    return (
        ...
        >
            <SwitchPrimitive.Thumb
                className="pointer-events-none h-5 w-5 rounded-full bg-foreground transition-transform duration-200 ease-in-out data-[state=unchecked]:translate-x-0.5 data-[state=checked]:translate-x-[26px]"
            />
        </SwitchPrimitive.Root>
    )
}

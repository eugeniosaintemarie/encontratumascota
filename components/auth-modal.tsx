  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        if (!sessionReady) {
          setError(
            "No pudimos confirmar tu sesión. Probá recargar la página y volvé a iniciar sesión",
          );
          return;
        }
        onAuthSuccess?.();
    ...
    try {
      ...
      if (result.error) {
        ...
        if (
          ...
          setError(
            "Ya existe un usuario registrado con ese correo. Intentá con otro o iniciá sesión",
          );
        } else {

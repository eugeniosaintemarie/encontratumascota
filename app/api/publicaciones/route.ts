...
export async function GET(request: Request) {
  try {
    ...
    if (
      ...
      console.log(
        "[API /publicaciones GET] Using mock data as fallback due to database error",
      );
...
export async function POST(request: Request) {
  try {
    ...
    const tipoPublicacion = body.tipoPublicacion as
      | "perdida"
      | "adopcion"
      | "buscada";
